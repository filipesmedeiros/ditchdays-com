...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center h-full relative">
      <h1 className="text-center text-transparent text-10xl py-2 font-bold font-lc leading-[0.8] bg-clip-text bg-[url('/pictures/subscribe.jpg')] bg-[position:-90px_-46px] bg-[length:520px]">
        DITCH
        <br />
        DAYS
      </h1>
